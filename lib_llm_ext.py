...
_register_provider_instance(OpenRouterProvider(name="OpenRouterFree", var_name="OPENROUTER_API_KEY", model_name="openrouter/free", base_url="https://openrouter.ai/api/v1"))
